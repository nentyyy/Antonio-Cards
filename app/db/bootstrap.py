...
HOT_PATH_INDEXES: Sequence[str] = (
    ...
    "CREATE INDEX IF NOT EXISTS idx_bc_stars_payments_user_created ON bc_stars_payments (user_id, created_at DESC)",
    "CREATE INDEX IF NOT EXISTS idx_bc_stars_payments_item_created ON bc_stars_payments (item_key, created_at DESC)",
    "CREATE INDEX IF NOT EXISTS idx_bc_stars_payments_grant_status ON bc_stars_payments (grant_status, created_at DESC)",
